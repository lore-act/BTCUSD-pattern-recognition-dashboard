...
## 🖼️ Dashboard "in action" next to real Vantage account (for testing) 
   ...
   - the blueline is the MA 5 minutes price of the closest pattern found based on MSE, the green line connected to that, is the probable price prediction, that's why the time is represented with +1/+2/+3/+4/+5 minutes... till +30 minute
